...
p <- ggplot(
  dt_long,
  aes(x = year, y = cutoff, colour = panel_full)
) +
  #geom_point() +
  geom_line() +
  ...
  scale_x_continuous(limits = c(2016, 2026), breaks = seq(2018, 2024, by = 2), expand = expansion(mult = c(0, 0))) +
...
ggsave("Output/Fig_2_v5.png",p, width = 9.5, height = 6, units = 'cm')
